...
const ViewApplications = () => {
  ...
  // Function to fectch company Job Applications data
  ...
  return applicants ? applicants.length === 0 ? (
    ...
    <p className='text-xl sm:text-2xl'>No Applications to Show</p>   
  </div>
  ) : (
    <div className='container mx-auto p-4'>
      <div>
        <table className='w-full max-w-4xl bg-white border vorder-gray-200 max-sm:text-sm'>
          <thead>
